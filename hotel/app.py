...
HOTELS = {
    ...
    22: {
        ...
        "city": "Tokyo",
        "country": "Japan",
        "address": "8-2 Dogenzaka, Shibuya, Tokyo",
        "starRating": 4,
        "description": "Vibrant stay steps from Shibuya Crossing and late-night dining.",
        "imageUrl": "https://picsum.photos/seed/shibuya/400/300",
        "amenities": "WiFi,Gym,Restaurant,Bar",
        "roomTypes": [
            _room("STD", "Standard", 190.00, False, 28),
            _room("DLX", "Deluxe", 260.00, True, 14),
        ],
        "availableRooms": 5,
    },
    23: {
        ...
        "city": "Bangkok",
        "country": "Thailand",
        "address": "299 Riverside Rd, Bangkok",
        "starRating": 5,
        "description": "Resort-style escape on the river with pool and spa.",
        "imageUrl": "https://picsum.photos/seed/chaophraya/400/300",
        "amenities": "WiFi,Pool,Spa,Gym,Restaurant,Bar",
        "roomTypes": [
            _room("STD", "Standard", 180.00, False, 24),
            _room("DLX", "Deluxe", 260.00, True, 16),
        ],
        "availableRooms": 5,
    },
    24: {
        ...
        "starRating": 4,
        "description": "Modern business hotel with easy access to Canary Wharf.",
        "imageUrl": "https://picsum.photos/seed/docklands/400/300",
        "amenities": "WiFi,Gym,Restaurant,Bar",
        "roomTypes": [
            _room("STD", "Standard", 210.00, False, 30),
            _room("DLX", "Deluxe", 290.00, True, 18),
        ],
        "availableRooms": 5,
    },
    25: {
        "hotelID": 25,
        "name": "Left Bank Riverside",
        "city": "Paris",
        "country": "France",
        "address": "23 Quai Saint-Michel, 75005 Paris",
        "starRating": 4,
        "description": "Riverside stay on the Left Bank near Notre-Dame.",
        "imageUrl": "https://picsum.photos/seed/leftbank/400/300",
        "amenities": "WiFi,Restaurant,Bar",
        "roomTypes": [
            _room("STD", "Standard", 210.00, False, 20),
            _room("DLX", "Deluxe", 310.00, True, 10),
        ],
        "availableRooms": 5,
    },
    26: {
        ...
        "city": "Singapore",
        "country": "Singapore",
        "address": "18 Riverside Quay, Singapore",
        "starRating": 4,
        "description": "Colourful riverside hotel close to dining, bars, and the CBD.",
        "imageUrl": "https://picsum.photos/seed/clarkequay/400/300",
        "amenities": "WiFi,Gym,Restaurant,Bar",
        "roomTypes": [
            _room("STD", "Standard", 180.00, False, 22),
            _room("DLX", "Deluxe", 250.00, True, 12),
        ],
        "availableRooms": 5,
    },
}
