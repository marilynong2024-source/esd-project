...
(33, 'Standard', 140, 2, 50, 42, 'Airport zone', 'https://picsum.photos/seed/r33a/400/300');"""
    ...
    bundles = [
        ...
        ("PKG_NYC", "London–New York hop", "London", "New York", 7, "Transatlantic classic", 20),
        ("PKG_AKL", "Auckland escape", "Sydney", "Auckland", 4, "North Island taste", 21),
        ("PKG_PHUKET", "Bangkok–Phuket combo", "Bangkok", "Phuket", 5, "Island add-on", 22),
        ("PKG_FRA", "Frankfurt fairs", "Singapore", "Frankfurt", 4, "Messe & Römer", 23),
